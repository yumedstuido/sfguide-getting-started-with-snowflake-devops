...
CREATE OR REPLACE API INTEGRATION git_api_integration
  ...
  API_ALLOWED_PREFIXES = ('https://github.com/yumedstuido') -- INSERT YOUR GITHUB USERNAME HERE
  ENABLED = TRUE;
...
CREATE OR REPLACE GIT REPOSITORY quickstart_common.public.quickstart_repo
  ...
  ORIGIN = 'https://github.com/yumedstuido/sfguide-getting-started-with-snowflake-devops.git'; -- INSERT URL OF FORKED REPO HERE
